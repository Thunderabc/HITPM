...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-14" data-genuitec-path="/HITpm/WebRoot/pmResults/Trace.jsp">
    ...
    <table border="1" style="width: 100%; " data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-14" data-genuitec-path="/HITpm/WebRoot/pmResults/Trace.jsp">
		...
		<tr>
		  <td align="center">流程实例</td>
		  <td align="center">数量</td>
		  <td align="center">占流程总数的比例</td>
		</tr>
    	<%
    	 Trace.printTraceTable(out, Trace.getLog()); 
    	%>
    </table>
  </body>
</html>
