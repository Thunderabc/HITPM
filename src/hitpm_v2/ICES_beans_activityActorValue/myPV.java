...
public class myPV {
	public static void spvmMiner(JspWriter out, XLog log)
		...
		HashMap<String, HashMap<String,ActorValue>>  processValue = mineProcessValue(log);
		//������̼�ֵ��ϣ��
...
//					System.out.print("    "+actor+"= { ");
	...
	public static HashMap<String, HashMap<String,ActorValue>>  mineProcessValue(XLog log) throws IOException, ParseException {
		//Write w = new Write();
